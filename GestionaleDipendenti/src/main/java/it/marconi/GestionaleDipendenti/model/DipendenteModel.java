package it.marconi.GestionaleDipendenti.model;
...
public class DipendenteModel {
    ...
    private String sede_appartenenza;
    ...
    public String getSede_appartenenza() {
        return sede_appartenenza;
    }

    public void setSede_appartenenza(String sede_appartenenza) {
        this.sede_appartenenza = sede_appartenenza;
    }
}
